  ...
  return (
    <div className={classes.container}>
      <div className={classes.wrapper}>
        <div className={classes.profiile}>
        ...
        <div className={classes.buttons}>
          <button className={`${classes.button} ${activeBtn === 0 && classes.active}`} onClick={() => setActiveBtn(prev => 0)}>Listed Properties</button>
          <button className={`${classes.button} ${activeBtn === 1 && classes.active}`} onClick={() => setActiveBtn(prev => 1)}>Listed Yachts</button>
          <button className={`${classes.button} ${activeBtn === 2 && classes.active}`} onClick={() => setActiveBtn(prev => 2)}>Bookmarked Properties</button>
          <button className={`${classes.button} ${activeBtn === 3 && classes.active}`} onClick={() => setActiveBtn(prev => 3)}>Bookmarked Yachts</button>
        </div>
                  ...
                  <div key={listedProperty._id} className={classes.property}>
                    ...
                    <div className={classes.details}>
                      ...
                      <div className={classes.moreDetails}>
                        ...
                        <span>{listedProperty.sqft} square feet<FaSquareFull className={classes.icon} /></span>
                      </div>
                  ...
                  <div key={bookmarkedProperty._id} className={classes.property}>
                    ...
                    <div className={classes.details}>
                      ...
                      <div className={classes.moreDetails}>
                        ...
                        <span>{bookmarkedProperty.sqft} square feet<FaSquareFull className={classes.icon} /></span>
                      </div>
                      <div className={classes.desc}>
                        {bookmarkedProperty.desc}
                      </div>
                    </div>
                  </div>
