    ...
    <div className={classes.container}>
      ...
      {success && (
        <div classname={classes.success}>
          You have successfully contacted the owner!
        </div>
      )}
      {shortComment && (
        <div>
      ...
      <div className={classes.commentSection}>
        {/* comment input */}
        {user?._id == null && <h3 style={{ margin: '0.75rem', fontSize: '24px' }}>Must sign in to post a comment!</h3>}
        {user?._id != null && <div className={classes.commentInput}>
          <img src={`http://localhost:5000/images/${user?.profileImg}`} />
          <input value={commentText} type="text" placeholder='Write a comment...' onChange={(e) => setCommentText(e.target.value)} />
